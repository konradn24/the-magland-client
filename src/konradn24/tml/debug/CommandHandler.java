...
public class CommandHandler {
	...
	public static String handle(DebugConsole console, String cmd) {
		String command;
		String[] args;
		...
		try {
			Method method = DebugCommands.class.getMethod(command, DebugConsole.class, String[].class);
			
			if(!method.isAnnotationPresent(Command.class))
				throw new NoSuchMethodException("@Command annotation not found");
			
			String response = method.invoke(null, console, args).toString();
