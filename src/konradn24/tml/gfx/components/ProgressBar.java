...
public class ProgressBar extends Component {
	...
	public ProgressBar(int x, int y, int width, int height, double maxValue) {
		super(x, y, width, height);
	...
	public ProgressBar(int x, int y, int width, int height, double minValue, double maxValue) {
		super(x, y, width, height);
